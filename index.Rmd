...
fig1 <- plot_ly(x = ~vasos1mCoronarioDataset$x, y = ~vasos1mCoronarioDataset$y, type = 'scatter', mode = 'lines', name = '1 vaso', fill = 'tozeroy')%>% 
...
fig2<-plot_ly(x = ~vasos1fCoronarioDataset$x, y = ~vasos1fCoronarioDataset$y, type = 'scatter', mode = 'lines', name = '1 vaso', fill = 'tozeroy')%>% 
