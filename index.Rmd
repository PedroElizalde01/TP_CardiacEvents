...
```{r ,echo=FALSE}
plot_ly(dataset, labels = ~SEXO, type = 'pie',width = 1120, height = 500, marker = list(colors = c('#02262e', '#99e4db'))) %>%
  layout(title = '',
...
subplot(fig1,fig2)%>%
 ...
 list(x = 0.2 , y = 1.05, text = "Men", showarrow = F, xref='paper', yref='paper'),
  list(x = 0.8 , y = 1.05, text = "Women", showarrow = F, xref='paper', yref='paper')),
 xaxis = list(title = 'Age'),yaxis = list(title = 'Density'))
