...
plot_ly(alpha = 0.7, orientation = 'h') %>%
  ...
  add_histogram(y = between60n80$EDAD, name = "Between 60 and 80") %>%
  add_histogram(y = between40n60$EDAD, name = "Between 40 and 60") %>%
  add_histogram(y = between20n40$EDAD, name = "Between 20 and 40") %>%
