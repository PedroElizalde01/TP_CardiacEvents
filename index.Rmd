...
plot_ly(alpha = 0.7, orientation = 'h') %>%
  ...
  add_histogram(y = between40n60$EDAD, name = "Between 40 and 59", marker = list(color ='rgba(183,124,67,1)')) %>%
  add_histogram(y = between20n40$EDAD, name = "Between 20 and 39", marker = list(color ='rgba(183,124,67,1)')) %>%
  add_histogram(y = less20$EDAD, name = "Less than 20", marker = list(color ='rgba(255,127,14,1)')) %>%
