...
plot_ly(alpha = 0.7, orientation = 'h') %>%
  add_histogram(y = more80$EDAD, name = "More than 80", marker = list(color ='rgba(18,61,92,1)')) %>%
  add_histogram(y = between60n80$EDAD, name = "Between 60 and 79", marker = list(color ='rgba(25,90,136,1)')) %>%
  add_histogram(y = between40n60$EDAD, name = "Between 40 and 59", marker = list(color ='rgba(31,119,180,1)')) %>%
  add_histogram(y = between20n40$EDAD, name = "Between 20 and 39", marker = list(color ='rgba(43,147,219,1)')) %>%
  add_histogram(y = less20$EDAD, name = "Less than 20", marker = list(color ='rgba(86,169,228,1)')) %>%
...
plot_ly(alpha = 0.6) %>%
  add_histogram(x = diabetes$PROCEDIMIENTO, name = "Diabetes",marker = list(color = 'rgba(31,119,180,1)')) %>%
  add_histogram(x = epoc$PROCEDIMIENTO, name = "EPOC",marker = list(color = 'rgba(183,124,67,1)')) %>%
  add_histogram(x = obesidadMor$PROCEDIMIENTO, name = "Obesidad Morbida",marker = list(color = 'rgba(255,127,14,1)')) %>%
  layout(barmode = "group", title = "")
```
...
plot_ly(alpha = 0.6) %>%
  add_histogram(x = cerovasos$PROCEDIMIENTO, name = "Cero Vasos", marker = list(color = 'rgba(31,119,180,1)')) %>%
  add_histogram(x = unVaso$PROCEDIMIENTO, name = "Un Vaso", marker = list(color = 'rgba(105,122,125,1)')) %>%
  add_histogram(x = dosVasos$PROCEDIMIENTO, name = "Dos Vasos", marker = list(color = 'rgba(183,124,67,1)')) %>%
  add_histogram(x = tresVasos$PROCEDIMIENTO, name = "Tres Vasos", marker = list(color = 'rgba(255,127,14,1)')) %>%
layout(barmode = "group", title = "")
```
