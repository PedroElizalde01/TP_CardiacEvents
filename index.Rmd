...
```{r ,echo=FALSE}
plot_ly(dataset, labels = ~SEXO, type = 'pie',width = 1120, height = 500) %>%
  layout(title = '',
...
plot_ly(x = ~density1$x, y = density1$y*2968.289173, type = 'scatter', mode = 'lines', name = 'Men', fill = 'tozerox',width = 1120, height = 500)%>% 
...
fig1 <- plot_ly(x = ~vasos1mCoronarioDataset$x, y = ~vasos1mCoronarioDataset$y*2608.820422, type = 'scatter', mode = 'lines', name = '1 vessel', fill = 'tozeroy',width = 1120, height = 500)%>% 
