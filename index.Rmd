...
<div class="content">
<div class="header3">
## We decided to predict whether the patients should go to Angioplasty or Surgery
<h4>After our research, the factors that will be taken into account for the prediction are the following:
<ul>
  <li>Age</li>
  <li>Gender</li>
  <li>EPOC</li>
