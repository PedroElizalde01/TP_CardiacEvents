...
plot_ly(alpha = 0.7, orientation = 'h',width = 610, height = 550) %>%
...
```{r ,echo=FALSE}
plot_ly(dataset, labels = ~SEXO, type = 'pie',width = 610, height = 500) %>%
  layout(title = '',
...
plot_ly(alpha = 0.6,
        marker = list(color = c('rgba(0,80,99,1)', 'rgba(0,172,177,1)'), name = c("Angioplasty","Surgery")),width = 610, height = 500) %>%
...
plot_ly(x = ~density1$x, y = density1$y*2968.289173, type = 'scatter', mode = 'lines', name = 'Men', fill = 'tozerox',width = 610, height = 500)%>% 
...
plot_ly(alpha = 0.6,width = 610, height = 500) %>%
...
fig1 <- plot_ly(x = ~vasos1mCoronarioDataset$x, y = ~vasos1mCoronarioDataset$y*2608.820422, type = 'scatter', mode = 'lines', name = '1 vessel', fill = 'tozeroy',width = 610, height = 500)%>% 
...
fig2<-plot_ly(type = 'scatter', mode = 'lines', showlegend=FALSE,width = 610, height = 500)%>% 
