...
plot_ly(alpha = 0.6) %>%
  add_histogram(x = less20$EDAD, name = "Less than 20") %>%
  add_histogram(x = between20n40$EDAD, name = "20 and 40") %>%
  add_histogram(x = between40n60$EDAD, name = "40 and 60") %>%
  add_histogram(x = between60n80$EDAD, name = "60 and 80") %>%
  add_histogram(x = more80$EDAD, name = "more than 80") %>%
